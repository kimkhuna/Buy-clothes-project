...
// 버전 3.5 이상을 사용해야 합니다).
	...
	CString	m_Or_Id;	//주문자 아이디
	CString	m_Or_Name;	//주문자 성함
	CString	m_Or_Address;	//주문자 주소
	CString	m_Or_Products;	//주문한 상품
	CString	m_Or_Count;	//수량
	CString	m_Or_Size;	//사이즈
	CString	m_Or_Buy;	//결제 방법
